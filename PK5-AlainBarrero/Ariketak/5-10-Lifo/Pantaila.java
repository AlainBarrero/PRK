...
public class Pantaila {
	...
	public static void margotuSartu(int id, int sartu, int[] lifo){
		int ident = id+1;
		String s = "\t"+sartu;
		String tab = "\t";
		for(int i = 0; i<id; i++){
		...
		System.out.println(tab + "sartu."+ ident + tabM + s + lifoString);
	}
	
	public static void margotuAtera(int id, int sartu, int[] lifo){
		int ident = id+1;
		String s = "\t"+sartu;
		String tab = "\t";
		for(int i = 0; i<id; i++){
		...
		String lifoString = margotuLifo(lifo);
		System.out.println(tab + "atera."+ident + tabM + s + lifoString);
	}
